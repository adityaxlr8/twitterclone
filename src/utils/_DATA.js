let users = {
  swati_anand: {
    id: "swati_anand",
    name: "Swati Anand",
    avatarURL: require('./avatar/avatar2.jpg'),
  ...
  tylermcginnis: {
    id: "tylermcginnis",
    name: "Aditya Gupta",
    avatarURL: require('./avatar/avatar.jpg'),
  ...
  unnati_ninja: {
    id: "unnati_ninja",
    name: "Unnati Kumar",
    avatarURL: require('./avatar/avatar3.jpg'),
...
let tweets = {
  ...
  "5c9qojr2d1738zlx09afby": {
    ...
    likes: ['swati_anand', 'unnati_ninja'],
  ...
  "czpa59mg577x1oo45cup0d": {
    ...
    author: "unnati_ninja",
    timestamp: 1515043995650,
    likes: ['tylermcginnis', 'swati_anand'],
  ...
  "6h5ims9iks66d4m7kqizmv": {
    ...
    likes: ['unnati_ninja', 'tylermcginnis'],
  ...
  "sfljgka8pfddbcer8nuxv": {
    ...
    likes: ['swati_anand', 'tylermcginnis'],
    replyingTo: "hbsc73kzqi75rg7v1e0i6a",
    replies: [],
  },
